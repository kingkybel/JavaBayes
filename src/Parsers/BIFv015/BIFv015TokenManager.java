 ...
 * Token Manager.
 */
@SuppressWarnings("unused") public class BIFv015TokenManager implements
        BIFv015Constants
{
    ...
    private int jjMoveNfa_0(int startState, int curPos)
    {
        ...
        for (;;)
        {
            ...
            ++curPos;
            if ((i = jjnewStateCnt) == (startsAt = 46 - (jjnewStateCnt =
                                                         startsAt)))
            {
                return curPos;
            }
    ...
    public static final String[] jjstrLiteralImages =
    {
        ...
        "\164\141\142\154\145", null, null, null,
    ...
    public Token getNextToken()
    {
        ...
        for (;;)
        {
            ...
            try
            {
                ...
                while (curChar <= 44 && (0x100100003600L & (1L << curChar)) !=
                                        0L)
                {
                    curChar = input_stream.BeginToken();
                }
     ...
     * Constructor.
     */
    public BIFv015TokenManager(SimpleCharStream stream)
    {
     ...
     * Constructor.
     */
    public BIFv015TokenManager(SimpleCharStream stream, int lexState)
    {
        ReInit(stream);
        SwitchTo(lexState);
    }
