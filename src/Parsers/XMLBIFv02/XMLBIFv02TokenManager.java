 ...
 * Token Manager.
 */
@SuppressWarnings("unused") public class XMLBIFv02TokenManager implements
        XMLBIFv02Constants
{
    ...
    private int jjMoveNfa_0(int startState, int curPos)
    {
        ...
        for (;;)
        {
            ...
            ++curPos;
            if ((i = jjnewStateCnt) == (startsAt = 30 - (jjnewStateCnt =
                                                         startsAt)))
            {
                break;
            }
    ...
    {
        "", null, null, "\74", "\74\57", "\76", null, null, null, null, null,
        null,
     ...
     * Constructor.
     */
    public XMLBIFv02TokenManager(SimpleCharStream stream)
    {
     ...
     * Constructor.
     */
    public XMLBIFv02TokenManager(SimpleCharStream stream, int lexState)
    {
        ReInit(stream);
        SwitchTo(lexState);
    }
