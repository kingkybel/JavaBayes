 ...
 * Token Manager.
 */
@SuppressWarnings("unused") public class XMLBIFv03TokenManager implements
        XMLBIFv03Constants
{
    ...
    private int jjMoveNfa_0(int startState, int curPos)
    {
        ...
        for (;;)
        {
            ...
            ++curPos;
            if ((i = jjnewStateCnt) == (startsAt = 35 - (jjnewStateCnt =
                                                         startsAt)))
            {
                break;
            }
    ...
    {
        "", null, null, "\74", "\74\57", "\76", null, "\75", null, null, null,
        null,
        null, null, null, null, null, null, null, null,
        "\42\156\141\164\165\162\145\42",
        "\42\144\145\143\151\163\151\157\156\42",
        "\42\165\164\151\154\151\164\171\42", null, null, null, null, null, null,
        null,
    };
     ...
     * Constructor.
     */
    public XMLBIFv03TokenManager(JavaCharStream stream)
    {
     ...
     * Constructor.
     */
    public XMLBIFv03TokenManager(JavaCharStream stream, int lexState)
    {
        ReInit(stream);
        SwitchTo(lexState);
    }
